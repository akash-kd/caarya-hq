...
function BreadCrumb({ page1, page2, page3, click1, click2, click3, back }) {
  ...
  return (
    <div className="bg-dark-bg px-3 py-2 space-x-2 flex flex-row items-center font-lato -mt-2 tracking-wide text-primary-neutral-200 text-2xs border-b border-primary-neutral-100">
