...
const CityCard = ({ source, city }) => {
  return (
    <div className="md:max-w-[480px] relative mx-auto rounded-2xl">
      <img
        src={source}
        alt=""
        className="w-full object-fit h-full absolute z-[-100] rounded-2xl px-2"
      />
      <div className="flex flex-col px-8 py-3 mf:py-5 justify-end items-center md:items-start lg:justify-center">
